  ...
  return (
    <div className="hidden md:block">
      <div className="flex gap-x-3 items-center">
        <img src={filter} className="w-[35px]" alt="" />
        <p className="text-[28px] font-medium">Filter</p>
      </div>
      <hr className="h-[6px] bg-[#AFB091] w-[244px] rounded-[10px]" />
      ...
      <Accordion className="w-[244px]" defaultIndex={[0]} allowMultiple>
        <AccordionItem className="border-none">
          ...
          <AccordionPanel className="flex flex-col" pb={4}>
            <Box className="text-[24px] leading-[32px]">
